<template lang="pug">
.snippet-wrap
  h4 等高布局 display:table + table-cell
  .wrap.wrap4
    .parent
      .left
        p left
    ...
    .wrap.wrap5
      .parent
        ...
        .right
          ...
          p right
  .row
    h4 等高布局 overflow+margin-bottom+padding-bottom
    .wrap.wrap6
      .parent
        .left
          p left
...
<style scoped>
.snippet-wrap {margin: 20px 0;}
.title{background-color: #4CAF50; padding: 10px; color: #fff;}
.column{height: 100%;}
.column p{height: 100%; line-height: 100px; text-align: center; font-size: 30px; color: #fff; background-color: #8BC34A;}
